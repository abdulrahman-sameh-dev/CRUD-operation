    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                ...
                {{-- Header Gradient matching the Card --}}
                ...
                <form action="{{ route('employees.store') }}" method="POST" class="p-6 space-y-4">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700 flex items-center justify-end gap-3">
                        <a href="{{ route('dashboard') }}" 
                            class="px-4 py-2.5 bg-gray-50 dark:bg-gray-700 hover:bg-gray-8/80 00 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-200 text-xs font-semibold rounded-xl transition-all">
                            Cancel
                        </a>
                        <button type="submit" 
